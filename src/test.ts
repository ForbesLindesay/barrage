...
describe('barrage extensions', function () {
  describe('BarrageStream#syphon', function () {
    it('pipes data', function (done) {
      var source = new b.Readable<string>({
        read() {
          this.push('foo')
          this.push('bar')
          this.push(null)
  ...
  describe('BarrageStream#wait', function () {
    it('waits for `finish` or `end` events and catches `error` events', function (done) {
      var source = new b.Writable<string>({write(chunk, encoding, cb) {
        cb();
      }});
      source.write('foo');
      source.write('bar');
  ...
  describe('BarrageStream#buffer', function () {
    it('buffers the content of a Readable stream and catches `error` events', function (done) {
      const source = new b.Readable<string>({
        objectMode: true,
        read() {
          this.push('foo')
          this.push('bar')
      ...
      source.buffer().then(data => {
        ...
        const sourceB = new b.Readable<string>({
          objectMode: false,
          read() {
            this.push('foo');
            this.push('bar');
        ...
        const sourceC = new b.Readable<string>({
          objectMode: false,
          read() {
            this.push('foo');
            this.push('bar');
  ...
  describe('BarrageStream#map', function () {
    it('maps each element onto a new element', function (done) {
      const source = new b.Readable<number>({
        objectMode: true,
        read() {
          this.push(1)
          this.push(2)
    ...
    it('can be used in parallel', function (done) {
      var source = new b.Readable<number>({objectMode: true, read() {
        this.push(1)
        this.push(2)
        this.push(3)
        this.push(null)
  ...
  describe('BarrageStream#filter', function () {
    ...
    it('can be used asynchronously', function (done) {
      const source = new b.Readable<number>({objectMode: true, read() {
        this.push(1)
        this.push(2)
        this.push(3)
        this.push(null)
  ...
  describe('BarrageStream#bufferTransform', function () {
    ...
    it('supports an encoding option', function (done) {
      var source = new b.Readable<string>({objectMode: true,
        read() {
          this.push('h')
          this.push('e')
          this.push('l')
